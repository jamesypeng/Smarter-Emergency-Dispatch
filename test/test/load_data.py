...
ems_preds_path = "/Users/priyagupta/desktop/mids/w210/project/Smarter-Emergency-Dispatch/test/test/ems_calls_predict_2017-11-29.csv"
...
for line2 in reader_ems:
     t2 = Predictions(zcta=line2[0], year=line2[1], month=line2[2],day_of_month=line2[3],
        ...
        is_weekend=line2[8].strip(''),call_counts=line2[9])
     t2.save()
